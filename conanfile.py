...
class ComputationGraphConan(ConanFile):
    name = "computational_graph_c"
    version = "1.0.0"
    requires = ["math_c/1.0.0", "data_structure_c/1.0.0", "classification_c/1.0.0"]
    license = "GPL License"
    author = "Olcay Taner Yildiz olcay.yildiz@ozyegin.edu.tr"
    url = "https://github.com/StarlangSoftware/ComputationalGraph-C"
    description = "Simple Computational Graph Library"
    topics = ("")
